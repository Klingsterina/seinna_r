...
p_birting <- ifelse(p_gildi < 0.001, "<0,001", format(round(p_gildi, 3), decimal.mark = ","))
p_birting
```
...
Núlltilgáta (H0): Meðallaun eru jöfn milli allra þriggja landa
Gagntilgáta (H1): Að minnsta kosti eitt land hefur meðallaun sem eru frábrugðin launum hinna landanna
