...
```
Við athuguðum hvort marktækur munur væri á meðallaunum eftir því hvort fólk ynni í fjarvinnu eða staðvinnu. Meðaltöl voru borin saman með t-prófi og prófstærðin var t = `r round(k_ttest$statistic, 2)` með p-gildi = `r k_p_snyrt`. Þar sem p-gildið var < 0,05, höfnum við núlltilgátunni og ályktum að munur sé á launum eftir vinnufyrirkomulagi.
